...
{
	public class CourtTabScrollView : HorizontalScrollView
	{
		...
		private static CourtSlidingTabStrip mTabStrip;
		...
		public CourtTabScrollView(Context context) : this(context, null) { }

		public CourtTabScrollView(Context context, IAttributeSet attrs) : this(context, attrs, 0) { }

		public CourtTabScrollView (Context context, IAttributeSet attrs, int defaultStyle) : base(context, attrs, defaultStyle)
		{
			...
			mTabStrip = new CourtSlidingTabStrip(context);
		...
		public void PopulateTabStrip()
		{
			...
			for (int i = 0; i < adapter.Count; i++)
			{
				...
				tabView.Text = ((BookingCourtFragment.SamplePagerAdapter)adapter).GetHeaderTitle(i);
